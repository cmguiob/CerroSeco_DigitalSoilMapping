...
CSsp84 <- readOGR(dsn= paste(ruta,"./GIS/Poligonos/Límite_P.E-Cerro_seco_WGS84.shp", sep = ""))
CSsf84 <- st_as_sf(CSsp84, coords = c("long", "lat"), crs = 4326) 


# Cargar poligonos mineria 2019 y convertir a sf
min2019 <-readOGR(dsn= paste(ruta,"./GIS/Poligonos/Mineria_2019_4326.shp", sep = "")) 
min2019sf <- st_as_sf(min2019, coords = c("long", "lat"), crs = 4326)


# Cargar DEM y transformar a data frame para manipular con ggplot
DEM_ras84 <- raster(x = paste(ruta,"./GIS/DEM_derivados/DEM_CerroSeco_Clipped_4326.tif", sep = ""))
