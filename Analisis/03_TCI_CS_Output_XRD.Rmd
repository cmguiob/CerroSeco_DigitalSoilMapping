...
knitr::opts_chunk$set(echo = TRUE, fig.align="center", echo = FALSE, fig.width = 5.5)
...
theme_update(strip.background = element_blank(),
             ...
             # "#F8F4EF" is 0.2 loghter than "#f6f2ed" 
             plot.background = element_rect(color =  "#F8F4EF",
                                            fill =  "#F8F4EF", 
                                            size = 2),
             ...
             axis.title = element_text(colour = darken("#f6f2ed", 0.5, space = "HCL"))) 
...
p_riet <- RIET %>%
  ...
  theme(axis.text = element_blank(),
        ...
        strip.text.y.left = element_text(angle = 0, colour = darken("#f6f2ed", 0.5, space = "HCL")),
...
p_xrd <- ggplot() +
  ...
  theme(plot.margin = margin(50, 70, 20, 10), #top, right, bottom, left
        panel.grid = element_line(linetype = c("dashed"),
                                colour = darken("#f6f2ed", 0.05, space = "HCL")),
        axis.text.x = element_text(color = darken("#f6f2ed", 0.5, space = "HCL")),
