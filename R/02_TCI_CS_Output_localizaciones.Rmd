...
knitr::opts_chunk$set(echo = TRUE, warning = FALSE, fig.showtext = T, fig.retina = 1, fig.align = 'center', dpi = 300, out.width = "75%", dev = "ragg_png")
...
ggsave(file = "localizaciones.png", plot = p_localizaciones, device = device = ragg::agg_png, path = here::here("graficas"), width = 8, height = 8, units = "cm", dpi = 300)

ggsave(file = "perfiles.png", plot = p_layout, device = device = ragg::agg_png, path = here::here("graficas"), width = 10, height = 5, units = "cm", dpi = 300)
