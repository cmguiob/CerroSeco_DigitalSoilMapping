...
CShidro <- slab(hz5, fm= ID ~ ARENA + LIMO + ARCILLA + Fe_DCS + DENS_AP + KSmedia_cmd )
...
CSprops <- slab(hz5, fm= ID ~ K + CO + Ca_Mg_K + P + Si_OAA + CIC + BT + SB + Na + Ca_Mg + CE + pH + ARENA + LIMO + ARCILLA + Fe_DCS + DENS_AP + KSmedia_cmd)
