...
ggsave(file = "mineralogia_CS01.png", plot = p_layout_01, device = "png", type ="cairo", path = here::here("graficas"), dpi = 300, width = 5.8, height = 3.8)

ggsave(file = "mineralogia_CS03.png", plot = p_layout_03, device = "png", type ="cairo", path = here::here("graficas"), dpi = 300, width = 5.8, height = 5.75)
